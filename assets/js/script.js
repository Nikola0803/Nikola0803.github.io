...
(function($){
    ...
    if($("#googlemap").length > 0){
        ...
        var myOptions = {
            ...
            zoom: 15,
            center: new google.maps.LatLng(43.3195493, 21.8851651), //change the coordinates, you can find them in google.com/maps url
        ...
        var marker = new google.maps.Marker({
                ...
                map: map,
                position: new google.maps.LatLng(43.3195493, 21.8851651)  //change the coordinates, you can find them in google.com/maps and in the url
            
        });

        var infowindow = new google.maps.InfoWindow({
            
                content: "<div style='color:#222'><b>Nalazim se ovde</b><br/></div>"  //change the address
